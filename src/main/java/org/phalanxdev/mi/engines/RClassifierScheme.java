  ...
  protected void assembleRLearnerOptionsRPart( Map<String, Map<String, Object>> parameters, StringBuilder b,
    ...
    if ( !isRegression ) {
      ...
      if ( priorProp != null || splitProp != null ) {
        ...
        if ( !SchemeUtils.isEmpty( priorVal ) || !SchemeUtils.isEmpty( splitVal ) ) {
          b.append( "parms=list(" );

          if ( priorProp != null && !SchemeUtils.isEmpty( priorVal ) ) {
            b.append( "prior=c(" ).append( priorVal ).append( ")" );
          }

          if ( splitProp != null && !SchemeUtils.isEmpty( splitVal ) ) {
    ...
    if ( aProp != null && !SchemeUtils.isEmpty( aProp.get( "value" ).toString() ) ) {
