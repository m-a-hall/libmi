...
public class SchemeUtils {
  ...
  protected static Object stringToValue( String value, String type, Object beingConfigured, Method readMethod,
    ...
    if ( type.equalsIgnoreCase( "short" ) ) {
      result = !isEmpty( value ) ? new Short( value ) : null;
    } else if ( type.equalsIgnoreCase( "integer" ) ) {
      result = !isEmpty( value ) ? new Integer( value ) : null;
    } else if ( type.equalsIgnoreCase( "long" ) ) {
      result = !isEmpty( value ) ? new Long( value ) : null;
    } else if ( type.equalsIgnoreCase( "float" ) ) {
      result = !isEmpty( value ) ? new Float( value ) : null;
    } else if ( type.equalsIgnoreCase( "double" ) ) {
      result = !isEmpty( value ) ? new Double( value ) : null;
    } else if ( type.equalsIgnoreCase( "file" ) ) {
      result = !isEmpty( value ) ? new File( value ) : null;
    } else if ( type.equalsIgnoreCase( "boolean" ) ) {
      result = !isEmpty( value ) ? Boolean.parseBoolean( value ) : null;
